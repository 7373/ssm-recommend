...
import recommend.MySlopeOneRecommender;
import recommend.RecommendedByDB;

public class 基于myslope {
	@Test
	public void testMyslope() {
		/**
		 * 设置用户ID、和推荐的数量
		 */
		long userID = 5;
		...
		recommendation = new MySlopeOneRecommender().mySlopeOneRecommender(userID, size);
